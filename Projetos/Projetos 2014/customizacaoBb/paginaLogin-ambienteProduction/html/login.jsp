...
<head>
	...
	<style type="text/css">
		...
		* { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; }
		...
		header[role="banner"] .libraryInsperLogin { display: block; background: transparent url("https://insper.blackboard.com/bbcswebdav/institution/TAI/pagLogin/img/bibliotecaInsper.jpg") no-repeat 10px center; width: 100%; height: 150px; }
