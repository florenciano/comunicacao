...
<bbNG:cssBlock>
  <style type="text/css">
      ...
      * { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; }
      ...
      header[role="banner"] .libraryInsperLogin { display: block; background: transparent url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/campus0.jpg") no-repeat 10px center; width: 100%; height: 150px; }
