...
<div id="tudo">
    ...
    <div id="container">
    	<a href="javascript:AbrePop('requisitos_pop');" onMouseOver="Tip('<b>Requisitos de sistema</b>');" onMouseOut="UnTip()"  tabindex="2">
    		<div class="requisitos_bt">requisitos</div>
    	</a>
    	<!-- Requisitos de sistema -->
    	<div id="requisitos_pop">
	    	<a href="javascript:FechaPop('requisitos_pop')" tabindex="3">
	    		<div id="bt_fechar">fechar</div>
	    	</a>
       		<div id="requisitos_box" class="requisitos_topTit">
          		<div id="reqTitulo">Sistemas operacionais suportados</div>
          	</div>
        	<a href="javascript:(); "onmouseover="Tip('<b>Microsoft Windows</b><br>Windows 8 (64-bit) apenas IE 10<br>Windows 8 (32-bit) apenas IE 10<br>Windows 7 (64-bit)<br>Windows 7 (32-bit)<br>Windows Vista (64-bit)<br>Windows Vista (32-bit)<br>Windows XP (32-bit)');" onMouseOut="UnTip()">
        		<div id="requisitos_box" class="requisitos_topTit"></div>
    		</a>
        	<a href="javascript:(); "onmouseover="Tip('<b>Apple Mac OS</b><br>Mac OSX 10.8<br>Mac OSX 10.7 <b>Lion</b><br>Mac OSX 10.6 <b>Snow Leopard</b>');" onMouseOut="UnTip()">
        		<div id="requisitos_box" class="requisitos_topTit"></div>
        	</a>
        	<div id="requisitos_box" class="requisitos_topTit">
	    	...
	    	<div id="requisitos_box" class="requisitos_topTit">
	          	<p align="center">
	            	<a href="http://www.apple.com/safari/download/" target="_blank" class="link_alt" onMouseOver="Tip('<b>Safari</b><br>vers&otilde;es 4.0, 5.0 e 5.1');" onMouseOut="UnTip()"><img src="https://insper.blackboard.com/login/ico_safari.png" alt="Safari" width="50" height="72"></a>
	                <a href="http://www.google.com/chrome" target="_blank" class="link_alt" onMouseOver="Tip('&lt;b&gt;Google Chrome');" onMouseOut="UnTip()"><img src="https://insper.blackboard.com/login/ico_chrome.png" alt="Chrome" width="50" height="72"></a>
	                <a href="http://br.mozdev.org/download/" target="_blank" class="link_alt" onMouseOver="Tip('<b>Mozila Firefox</b><br>a partir da vers&atilde;o 3.6');" onMouseOut="UnTip()"><img src="https://insper.blackboard.com/login/ico_firefox.png" alt="FireFox" width="50" height="72"></a>
	            </p>
	    	</div>
	    ...
	    <!-- login -->
	    <div id="conteudo">
	        <div id="loginBoxInsper"><loginUI:loginForm /></div>
