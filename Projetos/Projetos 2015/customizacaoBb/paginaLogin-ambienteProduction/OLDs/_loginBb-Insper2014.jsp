...
<head>
	...
	<style type="text/css">
		...
		.icos-sprite, .icos-acrobat32x32, .icos-crhome42x42, .icos-firefox42x42, .icos-flash32x32, .icos-ie42x42, .icos-java52x32, .icos-macOSX62x52, .icos-safari42x42, .icos-windows62x52 { background: url('https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/icos-s7fb90a4ff8.png') no-repeat; }
		...
		* { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; }
		...
		body { font: normal 14px/1.6875 "verdana", "arial", "sans-serif"; background: #e6e7e8 url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/bg_texture_insper.png") no-repeat center top; }
		...
		header[role="banner"] .libraryInsperLogin { display: block; background: transparent url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/bibliotecaInsper.jpg") no-repeat 10px center; width: 100%; height: 150px; }
		...
		.contentLogin .titlePage { margin-top: 30px; background: #414042 url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/bg_texture_login.png") no-repeat center center; display: block; width: 100%; height: 120px; }
		...
		.linksOut a.acessibility:after { content: ""; display: inline-block; background: transparent url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/ico_linkOut.png") no-repeat center center; width: 12px; height: 12px; margin: 0 2px 0 5px; }
		...
		.perfilUsuario ul li .icoProfessor { background: url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/perfis/professor_target.png") no-repeat center 40%; }
		.perfilUsuario ul li .icoAluno { background: url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/perfis/aluno_target.png") no-repeat center 40%; }
		...
		.perfilUsuario ul li .perfis:hover .icoProfessor, .perfilUsuario ul li .perfis:focus .icoProfessor { background-image: url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/perfis/professor_hover.png"); }
		.perfilUsuario ul li .perfis:hover .icoAluno, .perfilUsuario ul li .perfis:focus .icoAluno { background-image: url("https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/perfis/aluno_hover.png"); }
	...
	<!--[if lt IE 9]>
        ...
        <script>window.html5 || document.write('<script src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/js/libs/html5shiv.js"><\/script>')</script>
    <![endif]-->
</head>
<body>
...
<div class="wrapper" role="main">
    <header class="headerLogin" role="banner">
        <div class="logos">
            <h1><img src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/logoInsper.png" alt="Logo Insper" title="Insper" class="left"></h1>
            <img src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/NewlogoBlackboard.png" alt="Logo Blackboard" class="right">
        </div>
        <div class="libraryInsperLogin"></div>
    </header>
    <section class="contentLogin">
        <div class="titlePage"><img src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/img/titleForm.png" alt="Ambiente Virtual de Aprendizagem" title="Ambiente Virtual de Aprendizagem"></div>
...
<!-- <script src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/js/libs/jquery-1.9.1.min.js"></script> -->
<script src="https://inspertest.blackboard.com/bbcswebdav/institution/DEA/pagLogin/js/main.js"></script>
</body>
</html>
</bbNG:genericPage>
