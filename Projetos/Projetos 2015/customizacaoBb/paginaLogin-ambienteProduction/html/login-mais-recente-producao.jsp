...
<style type="text/css">
  ...
  * { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; }
  ...
  .wrapper { background-color: #fff; margin: 0 auto; border: 1px solid #bcbec0; border-radius: 5px; box-shadow: 0 0 10px rgba(1, 1, 1, 0.1); -moz-box-shadow: 0 0 10px rgba(1, 1, 1, 0.1); -webkit-box-shadow: 0 0 10px rgba(1, 1, 1, 0.1); width: 910px; height: 635px; position: absolute; left: 50%; margin-left: -455px; top: 50%; margin-top: -310px; }
  ...
  .contentLogin { position: relative; margin-bottom: 175px; }
  ...
  .contentLogin .formLogin form { padding: 10px 20px; border: 1px solid #e6e7e8; height: 280px; position: relative; }
  ...
  .contentLogin .formLogin input[type="text"], .contentLogin .formLogin input[type="password"] { border: 1px solid #d2d3d4; color: #414042; padding: 10px; font: bold 12px "verdana", "arial", "sans-serif"; border-radius: 5px; }
  ...
  .contentLogin .formLogin input[type="submit"] { background-color: #c4161c; border: none; color: #ffffff; font: 400 12px "verdana", "arial", "sans-serif"; border-radius: 5px; padding: 10px 25px; margin: 0; cursor: pointer; position: absolute; left: 20px; top: 12em; }
  ...
  .contentLogin .formLogin .forgot { background-color: #414042; border: none; margin: 0; padding: 0; display: inline-block; border-radius: 5px; position: absolute; right: 20px; top: 10.3em; }
  ...
  .contentLogin #erroArea { font: normal 12px "verdana", "arial", "sans-serif"; text-align: center; position: absolute; width: 285px; top: 22.8em; left: 20px; }
  ...
  /* CUSTOM ELEMENTS STRANGER */
  div#loginRedirectProviders { margin: 0; font-size: .65em; width: 285px; position: absolute; top: 25em; left: 20px; }
  #loginRedirectProviders button { display: none; }
  #loginRedirectProviderList { display: block; width: 100%; border: none; background-color: transparent; }
  #loginRedirectProviders ul { z-index: 0; }
  #loginRedirectProviderList li { display: block; margin: 0;}
  #loginRedirectProviderList li:first-child a { border-radius: 4px; padding: 0; background-color: #c4161c; }
  #loginRedirectProviderList li a:hover, #loginRedirectProviderList li a:focus { background-color: #db191f; text-decoration: none; }
  #loginRedirectProviderList li .defaultProviderIcon { display: none; }
  #loginRedirectProviderList h4 { background-color: #c4161c; font-size: 12px; padding: 10px; text-align: center; border-radius: 4px; }
  #loginRedirectProviderList li:nth-child(2) { display: none; }
